...
FragTrap::FragTrap( void ) : ClapTrap(), _baseHitPoints(100), _baseAttackDamage(30) {
...
FragTrap::FragTrap(std::string const& name) : ClapTrap(name),
	_baseHitPoints(100), _baseAttackDamage(30) {
...
int		FragTrap::getBaseHitPoints( void ) const {
	return (_baseHitPoints);
}

int		FragTrap::getBaseAttackDamage( void ) const {
